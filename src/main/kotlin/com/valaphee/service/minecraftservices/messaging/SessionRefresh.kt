...
suspend fun HttpClient.refreshSession(uri: String = "https://messaging.mktpl.minecraft-services.net", authorization: String, request: SessionRefreshRequest) = post("$uri/api/v1.0/session/start") {
